...
mỗi trang dùng lại component nào, rủi ro xung đột file dùng chung. Chờ tôi duyệt rồi mới chạy batch.
```
...
- Tái dùng component sẵn có (đọc components/ + barrel); cần khác → variant/prop; KHÔNG đẻ trùng.
