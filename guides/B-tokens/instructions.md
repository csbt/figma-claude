...
- `get_design_context` + `get_screenshot` trên các **frame nguồn token** (2–4 frame) liệt kê trong
  `PROJECT.md` để lấy màu/typography/spacing thực tế. Không trang nào chứa đủ — phủ nhiều KIỂU
  (home / nội dung nhiều chữ / form) là đủ để seed scale; token còn thiếu sẽ bổ sung ở E/F.
